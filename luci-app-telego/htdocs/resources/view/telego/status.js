	...
	render: function() {
		...
		const root = E('div', {'class': 'telego-status-container'}, [
			...
			E('div', {'class': 'action-buttons'}, [
				E('button', {
					'id': 'btn-start',
					'class': 'btn btn-start action-btn',
					'onclick': "L.service.start('telego')"
				}, [L.text_('Start Service')]),
				E('button', {
					'id': 'btn-reload',
					'class': 'btn btn-reload action-btn',
					'onclick': "L.service.reload('telego')"
				}, [L.text_('Reload Config')]),
				E('button', {
					'id': 'btn-stop',
					'class': 'btn btn-stop action-btn',
					'onclick': "L.service.stop('telego')"
				}, [L.text_('Stop Service')]),
				E('button', {
					'id': 'btn-refresh',
					'class': 'btn btn-action action-btn',
